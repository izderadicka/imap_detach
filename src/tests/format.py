...
class Test(unittest.TestCase):
    ...
    def test_1(self):
        ...
        self.assertEqual(f.fmt('x{guest+test}y', guest='bla', test='kilik'), 'xbla_kiliky')
        self.assertEqual(f.fmt('x{xx|guest+test}y', guest='bla', test='kilik'), 'xbla_kiliky')
        self.assertEqual(f.fmt('x{guest+test|zz}y', guest='bla', test='kilik'), 'xbla_kiliky')
