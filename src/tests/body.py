...
BODY=([([(b'TEXT',
    ...
    ([(b'TEXT',
      ...
      (b'IMAGE',
       ...
       b'<part1.01050901.01000603@oracle.com>',
       None,
       b'BASE64',
       18158,
       None,
      ...
      (b'IMAGE',
       ...
       b'<part5.09080607.06070109@oracle.com>',
       None,
       b'BASE64',
       1808,
       None,
      ...
      (b'IMAGE',
       b'JPG',
       (b'NAME', b'ijcbgecj.'),
       b'<part6.05040701.09070509@oracle.com>',
       None,
       b'BASE64',
       12020,
       None,
      ...
      (b'IMAGE',
       b'JPG',
       (b'NAME', b'icfhaegi.'),
       b'<part8.00030901.09000500@oracle.com>',
       None,
       b'BASE64',
       12542,
       None,
      ...
      (b'IMAGE',
       b'JPG',
       (b'NAME', b'jdhhjfih.'),
       b'<part10.06070505.03070702@oracle.com>',
       None,
       b'BASE64',
       15004,
       None,
      ...
      (b'IMAGE',
       b'JPG',
       (b'NAME', b'biiddjee.'),
       b'<part12.09060909.01040008@oracle.com>',
       None,
       b'BASE64',
       12846,
       None,
      ...
      (b'IMAGE',
       b'JPG',
       (b'NAME', b'hidffibg.'),
       b'<part14.03000507.06070001@oracle.com>',
       None,
       b'BASE64',
       9902,
       None,
